                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <?php 
                                    ...
                                    <tr>
                                        <th><?php echo $_SESSION['order']['order_no'] ?></th>
                                        <td><?php echo $_SESSION['order']['order_date'] ?></td>
                                        <td>$ <?php echo $_SESSION['order']['total'] + $_SESSION['order']['shipping'] ?></td>
                                        <td>
                                    <?php switch($customer_order['status']) { 
                                        ...
                                        <td><a href="customer-order-details.php?order_no=<?php echo $_SESSION['order'][$i]['order_no'] ?>&customer_orderID=<?php echo $_SESSION['order'][$i]['customer_orderID'] ?>" class="btn btn-primary btn-sm">觀看詳細</a>
                                        </td>
                                    </tr>
                                <?php    } ?>
