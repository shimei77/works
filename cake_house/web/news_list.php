...
$query = $db->query("SELECT * FROM news ORDER BY published_at DESC LIMIT ".$start_from.",".$limit);
                ...
                <div class="col-sm-9" id="blog-listing">
                    ...
                    <div class="post">
                        ...
                        <p class="date-comments">
                            <i class="fa fa-calendar-o"></i> <?php echo $news['published_at']; ?>                        
                        </p>
                       
                        <p class="intro"><?php echo substr($news['content'],0,200)."..."; ?></p>
