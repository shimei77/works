...
<div id="top">
       <div class="container">
           <div class="col-md-6 offer" data-animate="fadeInDown">
               <a href="web/register.php?url=add" class="btn btn-success btn-sm" data-animate-hover="shake">前往加入會員</a>  <a href="#">立即取得200元購物金!</a>
           </div>
           ...
           <div class="modal-dialog modal-sm">
              ...
              <div class="modal-content">
                   ...
                   <div class="modal-body">
                       <form action="web/function/check_member.php" method="post">
       ...
       <div class="container">
           <div class="navbar-header">
               ...
               <div class="navbar-buttons">
                   ...
                   <a class="btn btn-default navbar-toggle" href="web/basket.php">
                       ...
                       (<?php echo count($_SESSION['Cart']); ?>)</span>
                   </a>
               </div>
           </div>
           <!--/.navbar-header -->
           ...
           <div class="navbar-buttons">
               ...
               <div class="navbar-collapse collapse right" id="basket-overview">
                   <a href="web/basket.php" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span class="hidden-sm">
                       (
                        <?php 
